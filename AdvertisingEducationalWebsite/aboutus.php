...
<header lang="en">
		...
		<span class="sign"><a href="services.php"><?php echo $lang['services'] ?></a></span>
        <span class="sign"><a class="act active" href="aboutus.php"><?php echo $lang['aboutus'] ?></a></span>
	</header>
	...
	<!--main-->
	<section class="centersectioninfo">
	<h1 class="centername"><span id="lebanesetag">Lebanese</span> Educational Services</h1>
	<p lang="en" class="aboutcenterinfo"><?php echo $lang['centeraboutusparagraph'] ?></p>
	
<h1 lang="en" class="aboutcenterinfo"><?php echo $lang['staysocialmedia'] ?></h1>
	<ul class="contactuspage">
		<li>
		  <a class="facebook" target="_blank" href="https://www.facebook.com/profile.php?id=100090677556572">
			<span class="faspan"></span>
			<span class="faspan"></span>
			<span class="faspan"></span>
			<span class="faspan"></span>
		...
		<li>
		  <a class="instagram" target="_blank" href="https://www.instagram.com/leseducational/?igshid=ZDdkNTZiNTM%3D">
			<span class="instaspan"></span>
			<span class="instaspan"></span>
			<span class="instaspan"></span>
			<span class="instaspan"></span>
...
<div class="footer-right">
    ...
    <a class="languages" href="aboutus.php?lang=en"><?php echo $lang['lang_en'] ?></a>
<span style="color:aliceblue"> | </span> <a class="languages" href="aboutus.php?lang=kr"><?php echo $lang['lang_kr'] ?></a>
</div>
</footer>
