...
<body style="height: 2000px;">
	...
	<header lang="en">
		...
		<span class="sign active"><a class="act active" href="index.php"><?php echo $lang['home'] ?></a></span>
	...
	<footer class="footer-distributed">
        ...
        <div class="footer-left">
            ...
            <p class="footer-company-name">Copyright © 2023 <strong>Banen</strong> All rights reserved</p>
        </div>
        ...
        <div class="footer-right">
            ...
            <a class="languages" href="index.php?lang=en"><?php echo $lang['lang_en'] ?></a>
            <span style="color:aliceblue"> | </span><a class="languages" href="index.php?lang=kr"><?php echo $lang['lang_kr'] ?></a>
        </div>
    </footer>
